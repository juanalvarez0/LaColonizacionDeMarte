...
st.image("https://techreport.com/wp-content/uploads/2023/09/Key-SpaceX-Statistics.jpg")
...
"- Primer lanzamiento y aterrizaje de un cohete reutilizado (Falcon 9 Vuelo 32 — 30 de marzo de 2017)."
"- Primera recuperación controlada del carenado del cohete (Falcon 9 Vuelo 32 — 30 de marzo de 2017)."
...
st.header("Haciendo la vida multiplanetaria")
"El objetivo de SpaceX es construir las tecnologías necesarias para que la vida sea multiplanetaria. Es la primera vez en los 4.000 millones de años de historia de la Tierra que es posible realizar ese objetivo y proteger la luz de la conciencia."
"En la Starbase del jueves 4 de abril, el ingeniero jefe de SpaceX, Elon Musk, ofreció una actualización de los planes de la empresa para enviar a la humanidad a Marte, el mejor destino para empezar a hacer la vida multiplanetaria."
"Todos los programas actuales de SpaceX, incluidos Falcon, Dragon, Starlink y Starship, forman parte integral del desarrollo de las tecnologías necesarias para hacer realidad las misiones a Marte. La actualización incluía prioridades a corto plazo para Starship que desbloquearán su capacidad de ser reutilizable de forma completa y rápida, el habilitador central para transformar la capacidad de la humanidad de enviar grandes cantidades de carga útil a órbita y más allá. Con más pruebas de vuelo, mejoras significativas del vehículo y misiones de retorno de astronautas a la superficie de la Luna con el programa Artemis de la NASA en breve, la emoción seguirá estando garantizada con Starship."
"La charla también incluye la mecánica y los retos de viajar a Marte, junto con lo que estamos construyendo hoy para permitir el envío de alrededor de un millón de personas y varios millones de toneladas a la superficie marciana en los próximos años."
st.header("Vehículos de lanzamiento")

st.subheader("Falcon 1")
